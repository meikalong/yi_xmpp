...
public class Chat extends Packet {
	 ...
	 *            the IQ type.
	 */
	public Chat(Type type, String ID) {
		this.element = docFactory.createDocument().addElement("iq");
		setType(type);
		setID(ID);
	}
	 ...
	 */
	public Chat(Element element, boolean skipValidation) {
	 ...
	 *         originating IQ.
	 */
	public static Chat createResultIQ(Chat iq) {
		...
		Chat result = new Chat(Type.result, iq.getID());
